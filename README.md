...
The current release is [`v0.4.1`](https://github.com/marcelpetrick/llmPEG/releases/tag/v0.4.1).
...
```bash
uv pip install llmpeg-0.4.1-py3-none-any.whl   # from a GitHub Release
